...
class StateStore extends EventEmitter {
   ...
   */
  public isRequestProcessing (requestPropertiesFilterString) {
  ...
  public triggerUpdate (propertyName) {
  ...
  public linkToComponentState (statePropertyValue, componentReference) {
  ...
  public unlinkToComponentState (componentReference) {
